...
public class MatisseActivity extends AppCompatActivity implements
    ...
    public void onAlbumLoad(final Cursor cursor) {
        ...
        handler.post(new Runnable() {
            ...
            @Override
            public void run() {
                if (mSpec.initAlbumName != null) {
                    while (cursor.moveToNext()) {
                        if (mSpec.initAlbumName.equals(cursor.getString(cursor.getColumnIndex("bucket_display_name")))) {
                            mAlbumCollection.setStateCurrentSelection(cursor.getPosition());
                            break;
                        }
                    }
                }
